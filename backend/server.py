...
Tono BookTok, directo, sin spoilers. Solo el texto, sin títulos."""
    ...
    chat = LlmChat(api_key=EMERGENT_LLM_KEY, session_id=f"premium-{book_id}-{lang}", system_message="Eres un crítico literario experto.").with_model("gemini", "gemini-3-flash-preview")
